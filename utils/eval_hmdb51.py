...
class HMDBclassification(object):
    ...
    def evaluate(self):
        ...
        if self.verbose:
            print ('[RESULTS] Performance on HMDB-51 video '
                   'classification task.')
...
if __name__ == '__main__':
    ...
    hmdb_classification = HMDBclassification(opt.annotation_path, opt.prediction_path, subset='validation', verbose=True, top_k=1)
